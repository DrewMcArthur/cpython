...
def _check_compression(compression):
    if compression == ZIP_STORED:
        ...
        raise NotImplementedError(f"That compression method is not supported. (got compression type = {compression}, expected one of {ZIP_STORED}, {ZIP_DEFLATED}, {ZIP_BZIP2}, or {ZIP_LZMA}")
